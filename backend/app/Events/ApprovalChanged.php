...
class ApprovalChanged implements ShouldBroadcast
{
    ...
    /**
     * Route this light real-time push to the dedicated `system` queue (own worker) so it never
     * queues behind heavy provisioning jobs on `default`. See scripts/backend.sh worker_sys.
     */
