...
class GroupController extends Controller
{
    ...
    {
        $data = $this->validateData($request, $group);
    ...
    private function validateData(Request $request, ?Group $group): array
    {
        return $request->validate([
            'group_name' => ['required', 'string', 'max:255', $this->uniqueNameCI('groups', 'group_name', $group?->id)],
