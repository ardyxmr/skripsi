    ...
    public function handle(
        ...
        if ($this->inventoryId) {
            ...
            $inv->update([
                ...
                // prepare() re-rendered tfvars with a freshly generated password → keep the row in sync.
                'login_username' => $resolved['ci_user'],
                'login_password' => $resolved['ci_password'],
            ]);
        } else {
            $inv = Inventory::create([
                ...
                'vm_name' => $this->vmName,
                'login_username' => $resolved['ci_user'],
                'login_password' => $resolved['ci_password'],   // encrypted at rest by the model cast
                ...
                // Hardening is no longer a provision-time choice (Stage 8): it's an on-demand,
                // catalog-bound Inventory action. A new VM starts un-hardened.
                'hardening_status' => 'Not Hardened',
