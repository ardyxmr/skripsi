...
return [
    ...
    */
    ...
    'redis' => [
        ...
        // SPA session store — on the :6380 `noeviction` instance (DB 2), NOT the :6379 allkeys-lru
        // cache, so active login sessions are never evicted under memory pressure (which would log
        // users out at random). Selected via SESSION_CONNECTION=session.
        'session' => [
