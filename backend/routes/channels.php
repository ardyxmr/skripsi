...
/*
 * Broadcast channel authorization. $user is resolved by the `auth:sanctum` guard from the Sanctum
 * stateful session cookie (see bootstrap/app.php statefulApi + withBroadcasting).
 *
