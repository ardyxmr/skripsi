  ...
  return (
    <div className="relative" ref={popoverRef}>
      ...
      <button
        ...
        className="relative p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-700/50 transition-opacity"
      >
        <Bell size={18} />
        {unreadCount > 0 && (
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-[380px] bg-white dark:bg-card rounded-modal shadow-modal border border-gray-100 dark:border-theme z-[100] animate-in slide-in-from-top-2 duration-200 flex flex-col overflow-hidden">
          {/* Header */}
          <div className="px-4 py-3 border-b border-gray-100 dark:border-theme flex items-center justify-between shrink-0 bg-slate-50/50 dark:bg-zinc-800/20">
          ...
          {/* Footer */}
          <div className="px-4 py-2 border-t border-gray-100 dark:border-theme bg-slate-50/50 dark:bg-zinc-800/20 text-center shrink-0">
            <button
