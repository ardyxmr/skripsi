...
const PALETTE = {
  ...
  neutral: {
    ...
    soft: 'bg-slate-50 border border-slate-200 text-slate-700 dark:bg-surface dark:border-theme dark:text-zinc-400',
    dot: 'bg-gray-400',
  },
  // Cyan — Ansible hardening in progress (config-only; the VM stays Active).
  hardening: {
    solid: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-400',
    soft: 'bg-cyan-50 border border-cyan-200 text-cyan-700 dark:bg-cyan-500/10 dark:border-cyan-500/20 dark:text-cyan-400',
    dot: 'bg-cyan-500',
  },
...
const TONE_BY_STATUS = {
  ...
  Reverted: 'revert',
  // in-progress
  Provisioning: 'info', Updating: 'updating', Deleting: 'danger', Hardening: 'hardening',
  // stopped (brown)
  Stopped: 'stopped',
  // neutral
