          ...
          {isBlocking && action === 'Delete' ? (
            <>
              ...
              <div className="flex justify-end mt-2">
                <button onClick={onClose} className="px-4 py-2 text-[13px] font-medium bg-slate-100 dark:bg-surface text-slate-700 dark:text-zinc-300 hover:bg-slate-200 dark:hover:bg-zinc-700 rounded-md transition-colors">Close</button>
              </div>
            </>
          ) : (
            <>
