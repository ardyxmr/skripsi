...
export default function ProviderForm({ isOpen, mode, data, onSubmit, onClose, onChange }) {
  ...
  const inputCls =
    'w-full px-3 py-2 border border-slate-300 dark:border-theme bg-white dark:bg-page text-slate-900 dark:text-slate-100 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-colors';
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-theme rounded-md p-4">
                <div className="mb-4">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Read-only credential used for resource discovery (e.g. PVEAuditor).</p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                ...
                <div className="mt-3 flex flex-col gap-1.5">
                  <label className="text-[12px] font-medium text-slate-700 dark:text-slate-300">Discovery Token Secret {!isEdit && <span className="text-rose-500">*</span>}</label>
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-theme rounded-md p-4">
                ...
                <div className="mt-3 flex flex-col gap-1.5">
                  <label className="text-[12px] font-medium text-slate-700 dark:text-slate-300">Provision Token Secret {!isEdit && <span className="text-rose-500">*</span>}</label>
                  <div className="relative">
              ...
              {/* Terraform Provider */}
              <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-theme rounded-md p-4">
                <label className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-4 block">Terraform Provider</label>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[12px] font-medium text-slate-700 dark:text-slate-300">Provider Source <span className="text-rose-500">*</span></label>
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[12px] font-medium text-slate-700 dark:text-slate-300">Provider Version <span className="text-rose-500">*</span></label>
