    ...
    <>
      ...
      <div className="flex h-[calc(100vh-100px)] w-full gap-4 pb-4">
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden">
          ...
          {/* Default Empty State */}
          {!activeTab && !isLoading && (
            <div className="w-full h-full flex flex-col items-center justify-center text-slate-400 dark:text-slate-500 animate-in fade-in duration-500">
          ...
          {/* Loading Skeleton */}
          {isLoading && activeTab && (
            <div className="w-full h-full flex items-center justify-center bg-white/50 dark:bg-card/50 rounded-card animate-in fade-in duration-200 border border-gray-200 dark:border-theme shadow-card">
            ...
            <div key={activeTab} className="flex flex-col gap-6 h-full animate-in slide-in-from-right-8 fade-in duration-300 fill-mode-both items-start w-full">
              <div className="shrink-0 w-full bg-white dark:bg-card border border-gray-200 dark:border-theme rounded-card p-4 shadow-card flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-[13px] text-slate-500 dark:text-slate-400 mt-1">Configuration panel coming soon.</p>
                </div>
              </div>
              <div className="flex-1 w-full overflow-y-auto custom-scrollbar flex flex-col gap-6 pr-1 pb-1">
                <div className="bg-white dark:bg-card border border-gray-200 dark:border-theme rounded-card shadow-card flex items-center justify-center p-20 text-slate-500 dark:text-slate-400 text-sm shrink-0">
